...
public final class LivingWorldView {
    ...
    private static final class World extends View {
        ...
        private void lots(Canvas c){p.setStyle(Paint.Style.STROKE);p.setStrokeWidth(4);p.setColor(Color.argb(105,255,255,255));lot(c,-910,-990,-250,-560);lot(c,250,-990,910,-560);lot(c,-910,250,-250,670);lot(c,250,250,910,670);lot(c,-910,720,-250,1090);p.setStyle(Paint.Style.FILL);}
        private void lot(Canvas c,float l,float top,float r,float bot){c.drawRoundRect(l,top,r,bot,28,28,p);}
        private void buildings(Canvas c){house(c,-850,760,-420,1060,"HOME",0,Color.rgb(164,83,63));academy(c,420,-940,850,-620,1);market(c,-850,290,-420,600,2);workshop(c,-850,-940,-420,-620,3);library(c,420,290,850,600,5);}
        ...
        /** Dedicated recreation zone. It is deliberately in the lower-left lot, completely separate from the Workshop lot above the road. */
