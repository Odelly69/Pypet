...
public final class AcademyLessonSession {
    ...
    public void recordRun(boolean passed){prefs.edit().putBoolean(lessonId+".ran",true).putBoolean(lessonId+".passed",passed).apply();}
    ...
    public boolean canAdvance(){
        switch(stage()){
            ...
            case WRITE:return prefs.getBoolean(lessonId+".passed",false);
            case RUN:return prefs.getBoolean(lessonId+".passed",false);
            case INSPECT:return prefs.getBoolean(lessonId+".inspected",false);
            case DEBUG:return prefs.getBoolean(lessonId+".passed",false);
            case PRACTICE:return prefs.getBoolean(lessonId+".passed",false);
            case CHALLENGE:return prefs.getBoolean(lessonId+".passed",false);
            case APPLY:return prefs.getBoolean(lessonId+".passed",false);
            case REFLECT:return prefs.getBoolean(lessonId+".reflected",false);
            default:return prefs.getBoolean(lessonId+".passed",false)&&prefs.getBoolean(lessonId+".inspected",false);
        }
    }
    ...
    public boolean readyToMaster(){return stage()==Stage.MASTER&&prefs.getBoolean(lessonId+".passed",false)&&prefs.getBoolean(lessonId+".inspected",false);}
}
