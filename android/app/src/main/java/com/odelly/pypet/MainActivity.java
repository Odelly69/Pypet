...
public class MainActivity extends Activity {
    ...
    private void enterWorld(){try{LivingWorldView.show(this);WorldBuilderView.attachToWorld(this);}catch(Throwable t){android.util.Log.e("PYPET","World startup failed",t);TextView fallback=new TextView(this);fallback.setText("🐾 PyPet\n\nYour World could not be opened.\nYour saved world is protected.\nPlease try again.");fallback.setTextSize(20);fallback.setGravity(17);fallback.setPadding(30,30,30,30);setContentView(fallback);}}
