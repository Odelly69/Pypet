...
/** Pypet starts in the living World. Optional systems are isolated so startup cannot fail because of one subsystem. */
public class MainActivity extends Activity {
    PypetAudio audio; PypetSafetyGuard safety;
    @Override public void onCreate(Bundle state) {
        super.onCreate(state); safety=new PypetSafetyGuard(this); initializeOptionalSystems(); enterWorld();
    }
