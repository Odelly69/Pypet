...
// This allowlist is intentionally kept in lockstep with PremiumCatalog.java.
const ALLOWED_PRODUCTS = new Set([
  "pypet_premium_cozy_home",
  "pypet_premium_garden",
  "pypet_premium_pet_outfits",
  "pypet_premium_music",
  "pypet_premium_treehouse",
  "pypet_premium_dragon_lair",
  "pypet_premium_space_station",
  "pypet_premium_arcade",
  "pypet_premium_world_expansion",
  "pypet_premium_royal_estate",
  "pypet_premium_creator_bundle",
...
export default async function handler(req,res){
  ...
  try{
    ...
    const result=await androidpublisher.purchases.products.get({packageName:PACKAGE_NAME,productId,token:purchaseToken});
